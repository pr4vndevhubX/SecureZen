...
class AlertStorage:
    ...
    def _init_database(self):
        ...
        print("[OK] Database tables initialized with IP extraction support")
    ...
    def store_alert(self, alert: Dict) -> int:
        ...
        try:
            ...
            if srcip or dstip:
                print(f"[OK] Stored alert {alert_id} | srcip: {srcip} | dstip: {dstip}")
            else:
    ...
    def mark_as_processed(self, alert_ids: List[int]):
        ...
        print(f"[OK] Marked {len(alert_ids)} alerts as processed")
