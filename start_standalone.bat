...
start "SecureZen: Syslog Pipeline" cmd /k "uv run python features/syslog_analysis/syslog_listener.py & echo --- & uv run python features/syslog_analysis/logai_pipeline.py"

:: 2. Start Standalone Backend
start "SecureZen: Backend" cmd /k "uv run python server_standalone.py"
